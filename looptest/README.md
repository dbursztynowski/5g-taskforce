### This page describes a simple experiment illustrating in-place pod vertical scaling and monitoring network function metric using Prometheus in Open5GS.
...
```
# complete record (option -s stands for "silent")
