...
> [!Note]
> Vertical scaling actually refers to containers as the containers (not Pods) are assigned actual resources as RAM or CPU. In this guide, the expressions "pod scaling" and "container scaling" are used interchangeably with container scaling in mind.
